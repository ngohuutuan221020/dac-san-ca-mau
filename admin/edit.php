                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="radio" value="<?= $array['feature'] ?>"  name="feature" style="margin-bottom: 12px;margin-right: 5px"/> <span style="font-size: 20;">Có</span> <span style="margin-left: 10px;"></span>
                                                    <input type="radio" value="<?= $array['feature'] ?>"  name="feature" style="margin-bottom: 12px;margin-right: 5px"/> <span style="font-size: 20;">Không</span>
                                                </div>
                                            </div>
